...
const dom = {
  ...
  workoutLocationInput: document.getElementById("workoutLocationInput"),
  workoutModeInput: document.getElementById("workoutModeInput"),
  ...
  workoutAddItemBtn: document.getElementById("workoutAddItemBtn"),
  workoutItemsContainer: document.getElementById("workoutItemsContainer"),
  workoutSessionActions: document.getElementById("workoutSessionActions"),
  workoutStartBtn: document.getElementById("workoutStartBtn"),
  workoutFinishBtn: document.getElementById("workoutFinishBtn"),
  workoutSessionStatus: document.getElementById("workoutSessionStatus"),
...
const exerciseApi = setupExercise({
  ...
  workoutLocationInput: dom.workoutLocationInput,
  workoutModeInput: dom.workoutModeInput,
  ...
  workoutAddItemBtn: dom.workoutAddItemBtn,
  workoutItemsContainer: dom.workoutItemsContainer,
  workoutSessionActions: dom.workoutSessionActions,
  workoutStartBtn: dom.workoutStartBtn,
  workoutFinishBtn: dom.workoutFinishBtn,
  workoutSessionStatus: dom.workoutSessionStatus,
